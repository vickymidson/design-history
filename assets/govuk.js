(function () {
  ...
  */
  Button.prototype.handleKeyDown = function (event) {
    ...
    if (target.getAttribute('role') === 'button' && event.keyCode === KEY_SPACE$1) {
  ...
  */
  ...
  var accessibleAutocomplete = /*@__PURE__*/getDefaultExportFromCjs(accessibleAutocomplete_min.exports);
